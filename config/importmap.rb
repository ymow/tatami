...
pin "vm" # @2.0.1
pin "pry" # @0.8.12
pin "ansi-regex" # @2.1.1
pin "ansi-styles" # @2.2.1
pin "bindings" # @1.5.0
pin "bl" # @0.4.2
pin "chalk" # @1.1.3
pin "child_process" # @2.0.1
pin "coffeescript" # @2.7.0
...
pin "inherits" # @2.0.4
pin "isarray" # @0.0.1
pin "object-keys" # @0.4.0
pin "pygmentize-bundled" # @2.3.0
pin "readable-stream/duplex", to: "readable-stream--duplex.js" # @1.0.34
pin "readable-stream/transform", to: "readable-stream--transform.js" # @1.1.13
pin "readline" # @2.0.1
pin "string_decoder" # @0.10.31
pin "strip-ansi" # @3.0.1
pin "supports-color" # @2.0.0
pin "through2" # @0.2.3
pin "xtend" # @2.1.2
pin "@hotwired/turbo-rails", to: "turbo.min.js"
pin "@hotwired/stimulus", to: "stimulus.min.js"
